...
//
//     divMain.classList.add('member')
//     let divName=document.createElement('div')
//
//     divName.innerHTML=`<strong><hr><i>${simpson.name}</i></hr></strong>`
//     let divSurname=document.createElement('div')
//
//     divSurname.innerHTML=`<strong><i>${simpson.surname}</i></strong>`
//     let divAge=document.createElement('div')
//     divAge.innerText=`Вік ${simpson.age}`
//
//     let pInfo=document.createElement('p')
//     pInfo.innerHTML=`<i>${simpson.info}</i>`
//
...
//     divMain.append(divSurname)
//     divMain.append(divAge)
//     divMain.append(pInfo)
