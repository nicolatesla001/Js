...
//     document.write(`<div class="div-style">
// <h2>${simpsons[i].name}
// ${simpsons[i].surname + '<br>'}</h2>
// <h2>${'Вік ' + simpsons[i].age + '<br>'}</h2>
// <p>${simpsons[i].info}</p>
// <img class="img-1" src="${simpsons[i].photo}" alt="${simpsons[i].name}">
//
//     </div>`)
// }
...
<img class="img-style-p" src="${product.image}" alt="${product.image}">
</div>`)
