...
let book2={name:'ДНК особистості' , numPage:352, genre:'економіка', author:'Брайан Трейсі' }


// 4. Створити масив об'єктів book з наступними полями  - назва, кількість сторінок, жанр, автори. Вивести кожну книгу
// як окремий об'єкт

let books=[book={ name : 'Скрам', numPage:279, genre:'бізнес'},
    book2={ name:'ДНК особистості', numPage:352, genre:'економіка', author:'Брайан Трейсі' } ]
console.log(books[0])
console.log(books[1])
